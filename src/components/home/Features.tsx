  ...
  return (
    <div className="w-full px-8 pb-8">
      <div className="max-w-[1093px] md:h-[650px] h-[1000px] justify-center m-auto flex flex-col items-start space-y-16">
        <div className="text-blue-950 text-[24px] md:text-[36px] satoshi-bold mb-8">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-8">
          <div className="flex flex-col items-start">
            ...
            <div className="text-lg satoshi-bold mb-2">Comprehensive Resources</div>
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="text-lg satoshi-bold mb-2">Academic Excellence</div>
            <div className="md:text-[18px] text-[16px] md:text-base text-gray-600">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="text-lg satoshi-bold mb-2">Accessible</div>
            <div className="md:text-[18px] text-[16px] md:text-base text-gray-600">
