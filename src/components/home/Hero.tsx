...
const Hero = (): JSX.Element => {
  return (
    <div className="w-full pt-8 px-8">
      <div className="max-w-[1093px] mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
        <div className="w-[356px] h-[351px] mdw-[586px] md:h-[407px] py-2.5 flex-col justify-start items-start gap-6 inline-flex">
          <div className="pr-2.5 justify-start items-center gap-2.5 inline-flex">
            <div className="md:w-[527px] w-[346px] md:text-[64px] self-stretch text-blue-950 text-[42px] satoshi-bold">
              Academic Success at your fingertips
            </div>
          </div>
          <div className="justify-start items-start gap-2.5 inline-flex">
            <div className="w-[356px] md:w-[556px] text-sky-500 text-[18px] md:text-[24px] satoshi-medium">
          ...
          <div className="px-2 py-2 bg-blue-950 rounded justify-center items-center gap-2.5 inline-flex">
            <Button className="text-white text-[18px] satoshi-medium" />
          </div>
        </div>
        <div>
          <div className="relative min-h-[451px] md:min-h-[556px] w-96 md:w-96 md:pt-0">
            ...
            <div className="relative">
              <div className="absolute top-[60.44px] right-[45.25px]">
                <img
                  className="w-[300px] h-[300px] md:w-[556.69px] rounded-full"
                  src="/__experimental/assets/stimage.jpg"
                  alt="Image"
                />
              </div>
              <div className="absolute top-[60.44px] right-[45.25px] md:w-[340px] w-[300px] h-[300px]  rounded-full bg-black opacity-50"></div>
            </div>
          </div>
        </div>
      </div>
